...
<br><div class="text-center">
                <div class="header">
    		 <div class="p-3 mb-2 bg-primary text-white"><h1>UPDATE PRODUCT</h1></div>
  		</div>
<nav class="navbar navbar-expand-lg navbar-light bg">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <div class="dropdown-menu">
	  ...
	  <td>
       <a href="pro_update.php" button class="btn btn-outline-secondary my-2 my-sm-0" type="submit">Update Product</a>
      </td>
	  <td>
				...
				<?php
					while($row=$result->fetch_assoc()):?>
						...
						<tr>
							...
							<td>
								<a href="pro_create.php?edit=<?php echo $row['product_code'];?>"
