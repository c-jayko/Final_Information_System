...
<br><div class="text-center">
                <div class="header">
    		 <div class="p-3 mb-2 bg-primary text-white"><h1>DELETE PRODUCT</h1></div>
  		</div>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <div class="dropdown-menu">
	  ...
	  <td>
	   ...
	   <td>
       <a href="pro_delete.php" button class="btn btn-outline-secondary my-2 my-sm-0" type="submit">Delete Product</a>
      </td>
	</ul>
				...
				<?php
					while($row=$result->fetch_assoc()):?>
						...
						<tr>
							...
							<td>
								<a href="pro_process.php?delete=<?php echo $row['product_code'];?>"
