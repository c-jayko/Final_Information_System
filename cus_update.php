...
<br><div class="text-center">
                <div class="header">
    		 <div class="p-3 mb-2 bg-primary text-white"><h1>UPDATE CUSTOMERS</h1></div>
  		</div>
<nav class="navbar navbar-expand-lg navbar-light bg">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <div class="dropdown-menu">
	  ...
	  <td>
       <a href="cus_update.php" button class="btn btn-outline-secondary my-2 my-sm-0" type="submit">Update Customer</a>
      </td>
	  <td>
				...
				<?php
					while($row=$result->fetch_assoc()):?>
						...
						<tr>
							...
							<td>
								<a href="cus_create.php?edit=<?php echo $row['customer_id'];?>"
